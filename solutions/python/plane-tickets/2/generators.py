...
def generate_seats(number):
    ...
    for counter in range(0, number):
        ...
        #early row number 13 detection so counter stays intact
        if row_number == 12 and counter % 4 == 3:
            row_number += 2
...
def generate_codes(seat_numbers, flight_id):
    ...
    #using ljust (left adjust) to fill remaining zeros
    #python ljust(<expected_width>, <character>)
    zeros = ""
